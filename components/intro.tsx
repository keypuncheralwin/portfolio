    ...
    <section className='mb-28 max-w-[50rem] text-center sm:mb-0'>
        <div className='flex items-center justify-center'>
            <div className='relative'>
                ...
                >
                <Image src={programmer} alt='Alwin Icon' 
                width='192'
                height='192'
                quality='95'
                priority={true}
        ...
        >
            ...
            rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition' href='#contact'>
                Contact me here <BsArrowRight className='opacity-70 group-hover:translate-x-1.5 transition'/>{' '}</Link>
                <a
